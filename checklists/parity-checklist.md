...
**Overrides that cap the score at Low regardless of the weighted total:** Context Completeness = 0; Blind-Spot Coverage = 0 on a financial/regulatory rule; Recall Floor = 0; `coincidental_match_risk: true`.

The last override matters most: a 100% parity match rate is never sufficient evidence on its own in this framework.
